...
public class ShoppingCartManualTest {
    ...
    public static void run() {
        ...
        BOGOCart.add(new CartItem("BOGO", "Shamboo", 50.0, 3)); // 100
        BOGOCart.add(new CartItem("BOGO", "Conditioner", 25.0, 3)); // 50
        ...
        if (total4 == 150.0) {
            ...
            System.out.println("FAILED: Simple cart total expected 150.0 but got " + total4);
            failedCount++;
        }
